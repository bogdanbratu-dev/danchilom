    ...
    >
      <div className="container-site flex h-16 items-center justify-between gap-4 md:h-20">
        ...
        {isAdmin ? (
          <Link
            href="/admin"
            className="inline-flex items-center gap-2 rounded-full bg-brand px-5 py-2.5 text-sm font-bold uppercase tracking-wide text-white transition-colors hover:bg-brand-soft"
          >
            ← Înapoi în admin
          </Link>
        ) : (
